                ...
                <ul class="nav navbar-nav navbar-right">
					<li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                          ...
                          <li><a href="viewFeedingSchedules">Feeding Schedules</a></li>
                          <li><a href="createFeedingSchedule">Add a Feeding Schedule</a></li>
                          <li><a href="updateFeedingSchedule">Update a Feeding Schedule</a></li>
                          <li><a href="assignFeedingSchedule">Assign a Feeding Schedule</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
